"""
Evaluation for the conditional DDPM (Cartoon Set 100k).
...
Examples:
  python evaluate.py --test fidelity  --root data/cartoonset100k --ckpt run100k.pt \
      --weights 0 1 3 5 8 10 15 --n_samples 256
  python evaluate.py --test diversity --root data/cartoonset100k --ckpt run100k.pt \
      --weights 0 1 3 5 8 10 15 --n_conditions 16 --n_per_condition 8
  python evaluate.py --test variance  --root data/cartoonset100k --ckpt run100k.pt \
...
def main():
    ...
    ap.add_argument("--ckpt", default="run100k.pt")
    ap.add_argument("--clf_ckpt", default="classifier100k.pt")
    ...
    if args.test in ("fidelity", "variance"):
        ...
        if os.path.exists(args.clf_ckpt):
            ...
            clf = train_classifier(ds, dims, device, epochs=args.clf_epochs,
                                   batch=args.clf_batch, workers=args.workers)
